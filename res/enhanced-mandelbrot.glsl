...
uniform dvec2 position;     // mouse position <-1,+1>
uniform double zoom;          // zoom [-]

#define n 100                 // iterations [-]
#define sh 7                  // fixed point accuracy [bits]
#define multipass 0           // multi pass?
#define inverted 0            // inverted/reciprocal position?
